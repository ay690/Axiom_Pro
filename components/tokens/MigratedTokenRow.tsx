...
import { Flame, Globe, Hand, Search, User, Trophy, Crown, Send, Sigma, Droplet, TestTube, Zap, Diamond, Instagram, Leaf } from 'lucide-react';
...
const MigratedTokenRow: React.FC<{ token: Token }> = ({ token }) => {
...
export default MigratedTokenRow;